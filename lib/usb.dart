...
class USBTest extends StatefulWidget {
  const USBTest({Key? key}) : super(key: key);

  @override
  State<USBTest> createState() => _USBTestState();
}

class _USBTestState extends State<USBTest> {
  String logData = "";
  String receivedData = "";
